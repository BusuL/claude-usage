...
if (args.includes('--help') || args.includes('-h')) {
  console.log(`
claude-usage - Visualise your Claude Code token usage
...
Examples:
  node src/index.js            Open dashboard in browser
  node src/index.js --port 8080  Use custom port
`);
  process.exit(0);
}
...
const server = app.listen(port, async () => {
  ...
  console.log(`\n  claude-usage dashboard running at ${url}\n`);
